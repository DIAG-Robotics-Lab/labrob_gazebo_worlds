...
class GazeboRosActorCommand : public ModelPlugin {
 ...
 private:
  ...
  /// the plugin will follow a path or velocity subscriber // path modality not available -> look at the original plugin
  ...
  double default_rotation_roll_;

  /// \brief Default rotation for an actor
  double default_rotation_yaw_;

  /// \brief Default actor type
